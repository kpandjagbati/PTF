...
const About = () => {
  return (
    <section id="about" className="section-spacing bg-base-200 mb-10 md:mb-24 overflow-hidden">
        ...
        <div className="flex justify-center items-center md:space-x-10 space-y-8 md:space-y-0 flex-col md:flex-row">
          <BlurFade inView delay={0.2} direction="left" className="shrink-0 w-full max-w-xs sm:max-w-sm md:max-w-none md:w-auto mx-auto md:mx-0">
            <motion.img
              ...
              className="w-full md:w-80 lg:w-96 max-h-[28rem] object-cover object-top rounded-box shadow-xl ring-2 ring-primary/20"
          ...
          <div className="md:ml-4 space-y-4 sm:space-y-5 w-full max-w-md mx-auto md:mx-0">
            {aboutSections.map((section, index) => (
              <BlurFade
                ...
                direction="right"
              >
                <div className="card card-hover bg-base-100 shadow-md w-full">
                  <div className="card-body flex-col sm:flex-row items-center gap-4 p-4 sm:p-5">
                    <motion.div
                      className="shrink-0"
                      whileHover={{ rotate: [0, -10, 10, 0], scale: 1.15 }}
                      transition={{ duration: 0.5 }}
                    >
                      <section.Icon className="text-primary w-8 h-8" />
                    </motion.div>
