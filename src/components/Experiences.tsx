...
const Experiences = () => {
  return (
    <section id="experiences" className="section-spacing mb-16">
      ...
      <div className="mb-12">
        <h2 className="text-lg font-semibold text-info mb-8 text-center">
          Stack technique
        </h2>
      ...
      <div>
        <h2 className="text-lg font-semibold text-info mb-8 text-center md:text-left">
          Parcours professionnel
        </h2>

        <div className="relative max-w-4xl mx-auto md:mx-0">
          <div
            className="absolute left-[1.65rem] md:left-[1.875rem] top-4 bottom-4 w-0.5 bg-gradient-to-b from-info/50 via-info/20 to-transparent hidden sm:block"
            aria-hidden
          />
              ...
              <BlurFade key={experience.id} inView delay={0.1 + index * 0.12} direction="left">
                <article className="relative flex gap-4 md:gap-6">
                  <div className="relative z-10 shrink-0 pt-1">
                    <div className="flex h-14 w-14 md:h-16 md:w-16 items-center justify-center overflow-hidden rounded-xl bg-base-100 shadow-lg ring-2 ring-info/25">
                  ...
                  <div className="card-hover min-w-0 flex-1 rounded-2xl border border-base-content/10 bg-base-200 p-5 md:p-6 shadow-lg">
                    ...
                    <ul className="mt-4 space-y-2 border-t border-base-content/10 pt-4">
